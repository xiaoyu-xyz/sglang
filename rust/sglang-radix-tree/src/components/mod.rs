...
pub trait TreeComponent<K: ChildKeyType, V: RadixValue = DefaultRadixValue> {
    ...
    //         self,
    //         node: UnifiedTreeNode,
    //         device_frees: dict[ComponentType, list[torch.V]],
    //         host_frees: dict[ComponentType, list[torch.V]],
    ...
    fn build_hicache_transfers(
        ...
        //         phase: CacheTransferPhase,
        //         *,
        //         mamba_pool_idx: Optional[torch.V] = None,
        //         host_indices: Optional[torch.V] = None,
        //         token_ids: Optional[Sequence[int]] = None,
        //         prefetch_tokens: int = 0,
        //         last_hash: Optional[str] = None,
        //     ) -> Optional[list[PoolTransfer<V>]]:
    ...
    fn commit_hicache_transfer(
        ...
        //         node: UnifiedTreeNode,
        //         phase: CacheTransferPhase,
        //         transfers: list[PoolTransfer<V>] = (),
        //         *,
        //         cache_actions: list[CacheAction<V> | ComponentAction],
        //         insert_result: Optional[InsertResult<V>] = None,
